...
- `AZURE_OPENAI_BASE_URL`: This is the base URL of the Azure OpenAI endpoint. If you have a different base URL, you can use this to set this environment variable instead of `AZURE_OPENAI_RESOURCE_NAME`.
