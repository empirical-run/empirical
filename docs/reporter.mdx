---
title: 'Reporter'
description: 'View test results in your terminal and a web browser'
---
...
This summary is available immediately after running test samples using the `npx empiricalrun` command.
...
The web app interactivity saves you the hassle of repeatedly navigating back to `empiricalrc.json` to configure, run and compare results. 
Using web app, one can seamlessly modify, execute and delete [runs](./configuration) in real-time, offering a much higher iteration speed and productivity.
